...
public class TemplatePoolDefinition extends Definable<StructureTemplatePool> {

    public TemplatePoolDefinition(ResourceKey<StructureTemplatePool> resourceKey, @NonNull StructureTemplatePool value, Holder.@Nullable Reference<StructureTemplatePool> holder) {
