...
public class TerrainFeatures {
    ...
    public static void register(PlacedFeatureRegistration reg) {
        ...
        PlacedFeatureDefinition diorite_cliff = PlacedFeatureDefinition.builder(PlacedFeatures.TERRAIN_DIORITE_CLIFFS, reg.getContext())
            .configuredFeature(new SimpleBlockFeature(BlockStateProvider.simple(Blocks.DIORITE)))
            .placementModifiers(
                BlockPredicateFilter.forPredicate(
                    BlockPredicate.anyOf(
                        BlockPredicate.allOf(
                            BlockPredicate.matchesBlocks(Blocks.STONE),
                            BlockPredicate.anyOf(BlockPredicate.matchesBlocks(new BlockPos(0, -1, 0), List.of(Blocks.AIR, Blocks.WATER)))),
                        BlockPredicate.allOf(
                            BlockPredicate.matchesBlocks(Blocks.DIRT, Blocks.STONE),
                            BlockPredicate.anyOf(BlockPredicate.matchesBlocks(new BlockPos(0, 1, 0), List.of(Blocks.AIR, Blocks.DIORITE)))),
                        BlockPredicate.allOf(
                            BlockPredicate.matchesBlocks(Blocks.DIRT, Blocks.STONE),
                            BlockPredicate.anyOf(
                                BlockPredicate.matchesBlocks(new BlockPos(1, 0, 0), List.of(Blocks.AIR)),
                                BlockPredicate.matchesBlocks(new BlockPos(-1, 0, 0), List.of(Blocks.AIR)),
                                BlockPredicate.matchesBlocks(new BlockPos(0, 0, 1), List.of(Blocks.AIR)),
                                BlockPredicate.matchesBlocks(new BlockPos(0, 0, -1), List.of(Blocks.AIR))),
                            BlockPredicate.allOf(
                                BlockPredicate.matchesBlocks(Blocks.GRASS_BLOCK, Blocks.DIRT),
                                BlockPredicate.anyOf(
                                    BlockPredicate.allOf(
                                        BlockPredicate.matchesBlocks(new BlockPos(1, -1, 0), List.of(Blocks.AIR, Blocks.WATER)),
                                        BlockPredicate.not(BlockPredicate.matchesBlocks(new BlockPos(-1, 0, 0), List.of(Blocks.GRASS_BLOCK)))),
                                    BlockPredicate.allOf(
                                        BlockPredicate.matchesBlocks(new BlockPos(-1, -1, 0), List.of(Blocks.AIR, Blocks.WATER)),
                                        BlockPredicate.not(BlockPredicate.matchesBlocks(new BlockPos(1, 0, 0), List.of(Blocks.GRASS_BLOCK)))),
                                    BlockPredicate.allOf(
                                        BlockPredicate.matchesBlocks(new BlockPos(0, -1, 1), List.of(Blocks.AIR, Blocks.WATER)),
                                        BlockPredicate.not(BlockPredicate.matchesBlocks(new BlockPos(0, 0, -1), List.of(Blocks.GRASS_BLOCK)))),
                                    BlockPredicate.allOf(
                                        BlockPredicate.matchesBlocks(new BlockPos(0, -1, -1), List.of(Blocks.AIR, Blocks.WATER)),
                                        BlockPredicate.not(BlockPredicate.matchesBlocks(new BlockPos(0, 0, 1), List.of(Blocks.GRASS_BLOCK))))))))),
                CountPlacement.of(256),
                InSquarePlacement.spread(),
                OffsetPlacement.ofTriangle(5, 10),
                HeightmapPlacement.onHeightmap(Heightmap.Types.OCEAN_FLOOR_WG),
                OffsetPlacement.of(ConstantInt.of(0), ConstantInt.of(0)),
                BiomeFilter.biome()
            )
            .build();
        ...
        PlacedFeatureDefinition mossify_grass = PlacedFeatureDefinition.builder(PlacedFeatures.TERRAIN_MOSSIFY_GRASS, reg.getContext())
            .configuredFeature(new SimpleBlockFeature(BlockStateProvider.simple(Blocks.MOSS_BLOCK)))
            .placementModifiers(CountPlacement.of(128),
                ...
                BlockPredicateFilter.forPredicate(
                    BlockPredicate.allOf(
                        ...
                        BlockPredicate.anyOf(
                            BlockPredicate.matchesBlocks(new Vec3i(1, 0, 0), List.of(Blocks.WATER)),
                            BlockPredicate.matchesBlocks(new Vec3i(-1, 0, 0), List.of(Blocks.WATER)),
                            BlockPredicate.matchesBlocks(new Vec3i(0, 0, 1), List.of(Blocks.WATER)),
                            BlockPredicate.matchesBlocks(new Vec3i(0, 0, -1), List.of(Blocks.WATER))
                        ))),
                InSquarePlacement.spread(),
        ...
        PlacedFeatureDefinition lush_plains_lake = PlacedFeatureDefinition.builder(PlacedFeatures.TERRAIN_LUSH_PLAINS_LAKE, reg.getContext())
            .configuredFeature(new LakeFeature(
                ...
                BlockPredicateFilter.forPredicate(
                    BlockPredicate.anyOf(
                        BlockPredicate.allOf(
                            BlockPredicate.matchesBlocks(Blocks.STONE),
                            BlockPredicate.anyOf(
                                BlockPredicate.matchesBlocks(new BlockPos(0, -1, 0), List.of(Blocks.AIR, Blocks.WATER))
                            )),
                        BlockPredicate.allOf(
                            BlockPredicate.matchesBlocks(Blocks.STONE, Blocks.DIRT),
                            BlockPredicate.anyOf(
                                BlockPredicate.matchesBlocks(new BlockPos(0, 1, 0), List.of(Blocks.AIR, Blocks.OAK_WOOD))
                            )),
                        BlockPredicate.allOf(
                            BlockPredicate.matchesBlocks(Blocks.STONE, Blocks.DIRT),
                            BlockPredicate.anyOf(
                        ...
                        BlockPredicate.allOf(
                            ...
                            BlockPredicate.anyOf(
                                BlockPredicate.allOf(
                                    BlockPredicate.matchesBlocks(new BlockPos(1, -1, 0), List.of(Blocks.AIR, Blocks.WATER)),
                                    BlockPredicate.matchesBlocks(new BlockPos(-1, 0, 0), List.of(Blocks.GRASS_BLOCK))
                                ),
                                BlockPredicate.allOf(
                                    BlockPredicate.matchesBlocks(new BlockPos(-1, -1, 0), List.of(Blocks.AIR, Blocks.WATER)),
                                    BlockPredicate.matchesBlocks(new BlockPos(1, 0, 0), List.of(Blocks.GRASS_BLOCK))
                                ...
                                BlockPredicate.allOf(
                                    BlockPredicate.matchesBlocks(new BlockPos(0, -1, 1), List.of(Blocks.AIR, Blocks.WATER)),
                                    BlockPredicate.matchesBlocks(new BlockPos(0, 0, -1), List.of(Blocks.GRASS_BLOCK))
                                ),
                                BlockPredicate.allOf(
                                    BlockPredicate.matchesBlocks(new BlockPos(0, -1, -1), List.of(Blocks.AIR, Blocks.WATER)),
                                    BlockPredicate.matchesBlocks(new BlockPos(0, 0, 1), List.of(Blocks.GRASS_BLOCK))
        ...
        PlacedFeatureDefinition oasis_patch = PlacedFeatureDefinition.builder(PlacedFeatures.TERRAIN_OASIS_PATCH, reg.getContext())
            ...
            .placementModifiers(
                ...
                OffsetPlacement.of(UniformInt.of(-5, 5), ConstantInt.of(0)),
                HeightmapPlacement.onHeightmap(Heightmap.Types.WORLD_SURFACE_WG),
        ...
        PlacedFeatureDefinition water_blob = PlacedFeatureDefinition.builder(PlacedFeatures.TERRAIN_WATER_BLOB, reg.getContext())
            .configuredFeature(new SimpleBlockFeature(BlockStateProvider.simple(Blocks.WATER)))
            .placementModifiers(BlockPredicateFilter.forPredicate(
                    BlockPredicate.allOf(
                        BlockPredicate.matchesTag(BlockTags.DIRT),
                        BlockPredicate.matchesBlocks(new BlockPos(0, 1, 0), List.of(Blocks.AIR, Blocks.WATER)),
                        BlockPredicate.matchesBlocks(new BlockPos(0, 0, -1), List.of(Blocks.DIRT, Blocks.WATER, Blocks.GRASS_BLOCK)),
                        BlockPredicate.matchesBlocks(new BlockPos(0, 0, 1), List.of(Blocks.DIRT, Blocks.WATER, Blocks.GRASS_BLOCK)),
                        BlockPredicate.matchesBlocks(new BlockPos(1, 0, 0), List.of(Blocks.DIRT, Blocks.WATER, Blocks.GRASS_BLOCK)),
                        BlockPredicate.matchesBlocks(new BlockPos(-1, 0, 0), List.of(Blocks.DIRT, Blocks.WATER, Blocks.GRASS_BLOCK))
                    )),
