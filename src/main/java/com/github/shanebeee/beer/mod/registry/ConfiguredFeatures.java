...
public class ConfiguredFeatures {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> DELTA_SULFUR_POOL = register("delta/sulfur_pool");
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> TREE_COTTON_CANDY_TREES = register("tree/candy_cane_trees");
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> TREE_DEAD_CORAL_TREES = register("tree/dead_coral_trees");
    public static final ResourceKey<ConfiguredFeature<?, ?>> TREE_DEAD_BRAIN_CORAL_TREE = register("tree/dead_brain_coral_tree");
    public static final ResourceKey<ConfiguredFeature<?, ?>> TREE_DEAD_BUBBLE_CORAL_TREE = register("tree/dead_bubble_coral_tree");
    public static final ResourceKey<ConfiguredFeature<?, ?>> TREE_DEAD_FIRE_CORAL_TREE = register("tree/dead_fire_coral_tree");
    public static final ResourceKey<ConfiguredFeature<?, ?>> TREE_FALLEN_CRIMSOM_STEM = register("tree/fallen_crimson_stem");
    public static final ResourceKey<ConfiguredFeature<?, ?>> TREE_FALLEN_STRIPPED_CRIMSOM_STEM = register("tree/fallen_stripped_crimson_stem");
