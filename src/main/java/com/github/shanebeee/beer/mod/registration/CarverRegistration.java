...
public class CarverRegistration extends BaseRegistration<WorldCarver, CarverDefinition> {

    public CarverRegistration(BootstrapContext<WorldCarver> context) {
        super(Registries.CARVER, context);
    ...
    private CarverDefinition createCave(ResourceKey<WorldCarver> key, float probability, VerticalAnchor minY, VerticalAnchor maxY) {
        return CarverDefinition.caveBuilder(key, getContext())
            ...
            .roomVerticalRadiusMultiplier(UniformFloat.of(0.1f, 0.4f))
            .build();
    }
