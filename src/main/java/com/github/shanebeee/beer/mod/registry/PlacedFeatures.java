...
public class PlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> DECOR_HANGING_CHAIN = register("decor/hanging_chain");
    ...
    public static final ResourceKey<PlacedFeature> TREE_JAPANESE_MAPLE = register("tree/japanese_maple");
    ...
    public static final ResourceKey<PlacedFeature> TREE_WINDSWEPT_OAK = register("tree/windswept_oak");
